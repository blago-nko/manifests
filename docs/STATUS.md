...
## 2026-09-22 — пилот: дизайн-система и оригиналы

- Staging визуально принят Основателем 22.09.2026 (INFRA-075–081: токены, шкала, карточки, контейнеры, бренд-шапка, cookie-баннер).
- Оригиналы изображений пилота в `static/images/` (3264px вместо постовых вариантов ~630px).
- Открыто: INFRA-082 (Sticky Bottom Bar + полировка), INFRA-083 (rollout-план 12 сайтов).

## 2026-09-24 — пилот: дизайн-система 075–095 принята

- Staging визуально принят Основателем 24.09.2026 (INFRA-075–095: токены, шкала, карточки, контейнеры, бренд-шапка, cookie-баннер, бар, типографика, логотип, двухцветие, меню column).
- Логотип Основателя подключён (144px/128px, object-fit: contain).
- Документация синхронизирована: «13 сайтов на Hugo», CI-техдолг зафиксирован, реестр доменов в docs/domains-list.md.
- Открыто: INFRA-083 (rollout-план 12 сайтов), INFRA-096 (кастомная панель шаринга post-approve).
